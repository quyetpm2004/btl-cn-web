...
const full_name = z.string().min(1, 'full_name is required')
...
const apartment_id = z.coerce
  .number()
  .int()
  .positive('apartment_id must be a positive integer')
...
export const createResidentSchema = z.strictObject({
  ...
  status,
  registered_at,
  apartment_id: apartment_id.optional()
})
